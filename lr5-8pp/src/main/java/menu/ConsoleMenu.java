...
public class ConsoleMenu {
    ...
    ArrayList<Deposit> deposits = new ArrayList<>(10);
    ArrayList<MyDeposits> myDeposits = new ArrayList<>(3);
        ...
        while(choose !=7) {
            ...
            switch (choose) {
                case 1:
                    ...
                    break;
                case 2:
                    Command ChooseDesiredDeposit = new ChooseDesiredDeposit();
                    ChooseDesiredDeposit.execute();
                    break;
                case 3:
                    Command Replenishment = new Replenishment();
                ...
                case 4:
                    ...
                    break;
                case 5:
                    Command ShowMyDeposit = new ShowMyDeposit();
